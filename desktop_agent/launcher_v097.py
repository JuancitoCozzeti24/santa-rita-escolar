...
def maybe_run_component_probe_v2(probe) -> None:
    ...
    print("\nPRUEBA TERMINADA. El agente se cerrará ahora para no volver al menú de Classroom/SIEweb.")
    raise SystemExit(0)
...
def print_grade_cell_probe_v097(probe) -> None:
...
legacy.print_grade_cell_probe = print_grade_cell_probe_v097
