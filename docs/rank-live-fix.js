// Ranking live fix v2: fresh reads, request ordering and strict section isolation.
(function(){
  let rankRequestSeq=0;
  const SCHOOL=['2A','2B','5A','5B'];
  normalizeSec=function(s){
    const t=String(s||'').toUpperCase().replace(/[^25AB]/g,'');
    return SCHOOL.includes(t)?t:'';
  };
